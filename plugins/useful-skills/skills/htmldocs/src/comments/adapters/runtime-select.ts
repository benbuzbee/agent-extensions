...
// So a non-null seed author means "hosted"; its absence means "local". Node-safe
// and DOM-free: it takes the resolved author and the two builders and returns the
// chosen MountDeps, constructing nothing itself.
